...
for k in range (len(mes)):
    ...
    for j in range (len(angles)):    
        angle = angles[j]   
        inpath_sim = '~/Documents/file_simulations/tbl_2018{}{}_01_trg/heppy/set_{}/sel_030/020_counts/tbl_n.process.htbin.{}.{}.txt'.format(month, date, folder, me, angle)
        inpath_data = '~/Documents/file_nanoAOD/tbl_nanoAOD_2018{}{}_01/sel_020/010_component_counts/tbl_n.component.htbin.{}.{}.txt'.format(month, date, me, angle)
        ...
        sbs = tbl_sim 
        sbs['cumn'] = sbs['n']
        sbs = sbs[sbs.process != 'T1tttt_1350_1100']
        sbs = sbs[sbs.process != 'T1tttt_1950_500']
        sbs = sbs[sbs.process != 'T2bb_675_600']
        sbs = sbs[sbs.process != 'T2bb_1200_300']       
        ...
        dcs['process'] = dcs['component']
        sbs['component'] = sbs['process']
